...
function simple_dental_is_same_day_crowns_request() {
    ...
    return $request_path === simple_dental_get_same_day_crowns_path();
}
...
function simple_dental_get_sitemap_languages_for_path($path) {
    if ($path === simple_dental_get_same_day_crowns_path()) {
...
function simple_dental_get_page_lastmod_for_path($path) {
    ...
    if ($path === simple_dental_get_same_day_crowns_path()) {
        $template_path = get_template_directory() . '/page-same-day-crowns.php';
