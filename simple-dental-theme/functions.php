...
function new_patient_special_display($atts) {
    ...
    <div class="new-patient-special">
        ...
        <a href="<?php echo esc_url($booking_url); ?>" class="btn btn-coral" target="_blank" rel="noopener noreferrer"><?php echo __t('Book New Patient Visit', 'key:promo.new_patient.cta.button'); ?></a>
    </div>
    <?php
    return ob_get_clean();
}
